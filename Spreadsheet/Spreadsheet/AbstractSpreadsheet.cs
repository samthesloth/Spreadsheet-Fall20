...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        protected IEnumerable<String> GetCellsToRecalculate(ISet<String> names)
        {
            ...
            //Goes through cells. If unvisited, visits them
        ...
        /// Performs depth first search recursively on all cells connected to start to ensure no cycles are found.
        /// </summary>
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed)
        {
            //Add name to visited
            visited.Add(name);
            //Search through dependents to make sure the beginning cell isn't reached again
            foreach (String n in GetDirectDependents(name))
            {
                //If current cell is equal to original, there is a cycle
                if (n.Equals(start))
                {
                    throw new CircularException();
                }
                //If n is unvisited, visits that in order to reach all cells along path, recursively
